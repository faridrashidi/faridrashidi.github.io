!(function () {
  ...
  var e = window.document,
    ...
    l =
      i && r && r.prototype.attachShadow && !r.prototype.attachShadow.prototype,
    c = function (e, t, o, r) {
      null == t && (t = "&"),
        null == o && (o = "="),
    ...
    v = {
      light:
        ".btn{color:#A46F0D !important; transition: all .5s; border-color: #A46F0D !important; border: 1px solid transparent;}:root .btn{filter:none}.btn:focus,.btn:hover{color:#fff !important; background-color:#A46F0D; border:1px solid #A46F0D;}:root .btn:focus,:root .btn:hover{filter:none}.btn:active{background-color:#e9ecef;background-image:none;border-color:#acaeb0;border-color:rgba(27,31,35,.35);box-shadow:inset 0 .15em .3em rgba(27,31,35,.15);filter:none}.social-count{color:#A46F0D}.social-count:focus,.social-count:hover{color:#A46F0D}.octicon-heart{color:#ea4aaa}",
      dark: ".btn{color:#368ce2 !important; transition: all .5s; border-color: #368ce2 !important; border: 1px solid transparent;}:root .btn{filter:none}.btn:focus,.btn:hover{color:#fff !important; background-color:#368ce2; border:1px solid #368ce2;}:root .btn:focus,:root .btn:hover{filter:none}.btn:active{background-color:#181b1f;background-image:none;border-color:#252b30;border-color:rgba(27,31,35,.5);box-shadow:inset 0 .15em .3em rgba(27,31,35,.15);filter:none}.social-count{color:#368ce2}.social-count:focus,.social-count:hover{color:#368ce2}.octicon-heart{color:#ec6cb9}",
    },
    m = function (e, t) {
      return (
        "@media(prefers-color-scheme:" + e + "){" + v[b(v, t) ? t : e] + "}"
      );
    },
    w = {
      "mark-github": {
    ...
    k = function (e, t, o) {
      var r = h(e.ownerDocument),
        ...
        a =
          ...
          (function (e) {
            ...
            return (
              v[b(v, t["no-preference"]) ? t["no-preference"] : "light"] +
              m("light", t.light) +
              m("dark", t.dark)
            );
          })(t["data-color-scheme"]);
      n.styleSheet
        ...
        : n.appendChild(e.ownerDocument.createTextNode(a));
      var i,
        l,
        d = r(
          "a",
