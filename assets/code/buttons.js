! function() {
    ...
    var e = window.document,
        ...
        v = {
            light: ".btn{color:#A46F0D !important; transition: all .5s; border-color: #A46F0D !important; border: 1px solid transparent;}:root .btn{filter:none}.btn:focus,.btn:hover{color:#fff !important; background-color:#0085A1; border:1px solid #0085A1;}:root .btn:focus,:root .btn:hover{filter:none}.btn:active{background-color:#e9ecef;background-image:none;border-color:#acaeb0;border-color:rgba(27,31,35,.35);box-shadow:inset 0 .15em .3em rgba(27,31,35,.15);filter:none}.social-count{color:#A46F0D}.social-count:focus,.social-count:hover{color:#A46F0D}.octicon-heart{color:#ea4aaa}",
            dark: ".btn{color:#A46F0D !important; transition: all .5s; border-color: #A46F0D !important; border: 1px solid transparent;}:root .btn{filter:none}.btn:focus,.btn:hover{color:#fff !important; background-color:#0085A1; border:1px solid #0085A1;}:root .btn:focus,:root .btn:hover{filter:none}.btn:active{background-color:#181b1f;background-image:none;border-color:#252b30;border-color:rgba(27,31,35,.5);box-shadow:inset 0 .15em .3em rgba(27,31,35,.15);filter:none}.social-count{color:#A46F0D}.social-count:focus,.social-count:hover{color:#A46F0D}.octicon-heart{color:#ec6cb9}"
        },
        m = function(e, t) {
